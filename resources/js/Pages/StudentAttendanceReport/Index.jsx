...
import MonthlyStudentAttendance from './MonthlyStudentAttendance';
import ContinuousStudentAttendance from './ContinuousStudentAttendance';
...
export default function Index({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Student Attendance Report</h2>}
        >
                            ...
                            <div className="flex">
                                ...
                                <div className="w-3/4 pr-4">
                                    ...
                                    <div id="attendance-tab-content">
                                        {selectedTab === 'daily' && <DailyStudentAttendance selectedStudents={selectedStudents} />}
                                        {selectedTab === 'monthly' && <MonthlyStudentAttendance selectedStudents={selectedStudents} />}
                                        {selectedTab === 'continuous' && <ContinuousStudentAttendance selectedStudents={selectedStudents} />}
                                    </div>
                                </div>

                                {/* Student Selection Panel */}
                                <div className="w-1/4 pl-4 border-l border-gray-200">
                                    <StudentSelector onSelectStudents={handleStudentSelection} />
                                </div>
                            </div>
                        </div>
                    </div>
