...
export default function DailyStudentAttendance({ selectedStudents }) {
    ...
    }, [selectedDate, filter, selectedStudents]);
    ...
    const fetchDailyAttendance = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/reports/student-attendance/daily', {
                params: {
                    date: formattedDate,
                    filter: filter,
            ...
            setError('Failed to fetch daily student attendance.');
            console.error(err);
        } finally {
            setLoading(false);
        }
    ...
    const handleExport = async () => {
        try {
            ...
            window.open(`/api/reports/student-attendance/daily/export?${params}`, '_blank');
        } catch (err) {
            console.error('Failed to export daily student attendance:', err);
            alert('Failed to export daily student attendance.');
        }
    };

    return (
        <div className="daily-attendance-tab">
            <h3 className="text-lg font-semibold mb-4">Daily Student Attendance</h3>
